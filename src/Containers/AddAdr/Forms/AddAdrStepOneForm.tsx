      ...
      <PaddedWrapper>
        {
          pastMedicalHistories.map((pastMedicalHistory: any) =>
            <div key={pastMedicalHistory.ConfigName}>
              {getFieldDecorator(`pastMedicalHistory_${pastMedicalHistory.ConfigId}`)(
      ...
      <AdrFormItem>
        {getFieldDecorator('AdrPastTypeId')(
          <Radio
            ...
            options={[{ name: 'Yes', value: 56 }, { name: 'No', value: 58 }, { name: 'Unknown', value: 59}]} 
          />
        )}
      </AdrFormItem>
      <PaddedWrapper>
        ...
        <AddWrapper onClick={() => setPastHistories(prev => [...prev, prev.length])}>
